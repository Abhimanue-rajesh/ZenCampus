    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('view_book', 'Can view book'), ('add_book', 'Can add book'), ('change_book', 'Can change book'), ('delete_book', 'Can delete book'), ('add_libraryrecord', 'Can add library record'), ('view_libraryrecord', 'Can view library record'), ('change_libraryrecord', 'Can change library record'), ('delete_libraryrecord', 'Can delete library record')],
            },
            bases=('accounts.user',),
            managers=[
                ('objects', django.contrib.auth.models.UserManager()),
